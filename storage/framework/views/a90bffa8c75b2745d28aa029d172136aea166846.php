...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(route('register')); ?>"><b>Register</b> User</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
...
unset($__errorArgs, $__bag); ?>" placeholder="Password Confirmation">
                ...
                <p class="mb-0">
                    <a href="<?php echo e(route('login')); ?>" class="text-center">Saya Sudah Punya Akun</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\si-laravel\resources\views/register.blade.php ENDPATH**/ ?>